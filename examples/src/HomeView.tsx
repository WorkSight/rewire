...
function createTestGrid(nRows: number, nColumns: number) {
  ...
  cols.push(createColumn('sumColumn',               'Time Sum',            { type: { type: 'number', options: { decimals: 2 } }, validators: validator('sumOf', field('differenceColumn')), width: Math.trunc(Math.random() * 250 + 50) + 'px' }));
